...
namespace PlantsnNutritionRebalance.Scripts
{
    ...
    public class PlantsParametersPatch
    {
        [HarmonyPatch("LoadDataFiles")]
        [UsedImplicitly]
        [HarmonyPostfix]
        public static void ApplyPlantPatchesWhenPrefabsLoaded()
        {
            Debug.Log("Applying plants patches after prefabs are loaded");
            DisableSoybeanH2Exhale();
        ...
        public static void DisableSoybeanH2Exhale()
        {
            if (ConfigFile.DisableSoybeanH2Exhale)
            {
                try
                {
                    // Fetch the LifeRequirementsData that was loaded from XML
                    if (!DataCollection.TryGet<LifeRequirementsData>("LifeRequirementsItemSoybean", out LifeRequirementsData lifeReqData) || lifeReqData == null)
                    {
                        return;
                    }

                    var exhaled = lifeReqData.ExhaledGases;
                    if (exhaled == null)
                    {
                        return;
                    }
                ...
                {
                    Debug.LogError($"[PlantGrowthDebug] Exception in DisableSoybeanH2Exhale: {ex}");
                }
            }
        }
    }
    ...
    public class PlantGrowStagePatch
    {
        ...
        private static int[] cocoaTreeStages = { 1, 2400, 4800, 4800, 4800, 4800, 2400, -1, 0 };// 680051921 & 1139887531 
        private static int[] sugarCaneStages = { 1, 1200, 2000, 2000, 2000, 2400, 2400, -1, 0 }; // -1335056202 -1884103228
        ...
        private static int[] endothermicGenepool1Stages = { 1, 1200, 1200, 2400, 2400, -1, 0 }; //851290561 
        ...
        private static int[] switchGrassStages = { 1, 800, 800, 800, 800, 2000, 2400, -1, 0 }; //-532672323
        private static int[] strawberryStages = { 1, 1600, 3200, 4800, 4800, 4800, 2400, -1, 0 }; //
        private static int[] blueberryStages = { 1, 1600, 3200, 2400, 2400, 4800, 2400, -1, 0 }; //
        private static int[] watermelonStages = { 1, 2400, 4800, 4800, 4800, 4800, 2400, -1, 0 }; //
        ...
        static PlantGrowStagePatch()
        {
            ...
            plantStages.Add(-906450470, strawberryStages);   // ItemStrawberry
            plantStages.Add(173826094, blueberryStages);     // ItemBlueberry
            plantStages.Add(-1392622903, watermelonStages);  // ItemWatermelon
            ...
            plantStages.Add(488360169, switchGrassStages);
            plantStages.Add(2009884607, strawberryStages);
            plantStages.Add(897717596, blueberryStages);
            plantStages.Add(315264172, watermelonStages);
            plantStages.Add(-1740754636, endothermicGenepool1Stages);
            plantStages.Add(-475065916, endothermicGenepool2Stages);
            plantStages.Add(-1066145654, thermogenicGenepool1Stages);
            plantStages.Add(-969228551, thermogenicGenepool2Stages);
